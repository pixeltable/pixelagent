...
class Agent(BaseModel):
    ...
    clear_cache: bool = Field(
        False, description="Whether to recreate the agent from scratch"
    )
    ...
    def _setup_table_columns(self) -> None:
        ...
        self.agent_table.add_computed_column(
            answer=provider.get_answer_column(self.agent_table), if_exists="ignore"
        )
    ...
    def run(self, prompt: str) -> str:
        ...
        result = self.agent_table.tail(1)[0]
